...
29/11/23 & 1.1 & Added statistics to the User Business section, citations, and changed images to pdf\\
30/11/23 & 1.2 & Added intros to Scope of Product and Functional Requirements sections\\
01/12/23 & 1.3 & Added product use case numbers to Section 8.3 and added priorities/timelines to Section 21.2\\
05/03/24 & 1.4 & Removed/updated the following sections with outdated features to reflect the current state of the app:
FR4, FR6, FR9, AR3, PIR2, LR2, SLR1, EPER2, EPER3, IASR1, SPR2, APR1, ACCR1, ACR2, PRR1, PRR2, AUR1, CUR1, CUR3\\
01/04/24 & 1.5 & Added intros to all remaining sections of the SRS\\
03/04/24 & 1.6 & Added sentence explaining which SRS template is being used and explained arrows in work context model\\
\bottomrule
\end{tabularx}
