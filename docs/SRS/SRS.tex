...
\begin{itemize}
  ...
  \item \textbf{SR2}: Features and options should be grouped based on relation to each other to improve intuitiveness.
  \item \textbf{SR3}: Indicators and messages should to convey information such as for loading or errors as requested in \textit{E3}.
\end{itemize}
...
\begin{itemize}
  ...
  in \textit{E10}.
  \item \textbf{PAR2}: The app should return spending data to the user with correctness within 99\% of the intended value
