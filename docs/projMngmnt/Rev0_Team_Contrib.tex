...
\begin{itemize}
  ...
  \item \textbf{Sawyer Tang:} I have an addisitonal 13 commits on the master branch of our back-end repository \href{https://github.com/Tanger71/grocery-spending-tracker-backend}{here}. Additionally, I squash my commits to the main repo before merging into master. The total of these commits unsquashed go from 5 to 17 detailed \href{https://github.com/r-yeh/grocery-spending-tracker/commits?author=Tanger71&since=2023-11-13&until=2024-01-28}{here}. Thus, my true total commit total is 30.
