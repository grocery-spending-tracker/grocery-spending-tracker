...
for the Grocery Spending Tracker applicaiton. In particular, the results of the Functional Requirement System Tests,
...
the \textit{profile_provider_test} file executes tests related to the provider for profile functionality.
