...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Working knowledge of Flutter development and front-end design
    \item Knowledge working with Node.js and REST APIs
    \item Skills related to the use of the Tesseract-OCR engine
    \item Working knowledge of PostgreSQL
    \item Skills related to Natural Language Processing or Machine Learning
