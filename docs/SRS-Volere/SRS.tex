...
\begin{enumerate}
  ...
  which could be leveraged in addition to third-party articles.\\
  ...
  teach strong communication practices such as ones on \textit{Coursera} or \textit{LinkedIn Learning}.\\
