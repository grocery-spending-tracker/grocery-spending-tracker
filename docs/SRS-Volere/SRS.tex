...
\begin{itemize}
  \item \textbf{AR1}: The app should use a consistent colour scheme based on a chosen colour palette.
...
\begin{itemize}
  \item \textbf{SR1}: All app features and options should be in consistent locations to minimize hand readjustment.
