...
\begin{itemize}
    \item \textbf{CUR1:} The app should allow users to use the metric system, imperial system, or a combination of the two (Canadian) as requested in \textit{E11}
    \item \textbf{CUR2:} The app should account for uncommon purchase items as requested in \textit{E11}
    \item \textbf{CUR3:} The app should account for different currencies used (specifically USD and CAD) as requested in \textit{E11}
\end{itemize}
...
\begin{itemize}
  ...
  consider reasonable?
    ...
    \end{itemize}
  \item \textbf{E11:} For an app of this nature, what features or points of interest come to mind based on your identity as a Canadian?
    \begin{itemize}
