...
\underline{Rational}: Mobile devices are widly used and ubiquitous. While at a grocery store, users may need access to the system.\\
...
\underline{Rational}: System servers and databases are used to store collective user data and process that data. User's devices are required to communicate to with the servers and databases via internet access.\\
...
\underline{Rational}: Users will be using the system while they are out on their grocery trips. Thus, the system needs to have a quick and easy method of data input. This also makes it easier for those who have their hands full or do not have the finger mobility to effectively type on their phone keyboards.\\
...
No budget is provided for this porject. Any costs that are incurred by the project are at the cost of the developers.
