...
To show that this risk can be overcome, the Proof of Concept Demo will involve a very
simple application with just the OCR functionality implemented. Then, a receipt will be scanned and the output
will be displayed to show the feasibility of the OCR and input system. Ideally, the result of the demo will be
an accurate representation of data that was captured from the receipt.
