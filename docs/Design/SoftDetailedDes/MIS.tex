...
\begin{table}[H]
  \begin{tabular}{|p{0.2\linewidth}|p{0.2\linewidth}|p{0.5\linewidth}|}
    ...
    \hline
    dateTime & String & Date and time of purchase \\
    \hline
    ...
    \hline
    isTaxed & Boolean & Describes if the item is taxed\\
    \hline
...
\begin{itemize}
  \item transition: none
  \item output: $out := \textit{the classification result of the model for} \, \textit{inputItemData}$
...
\begin{itemize}
  \item transition: none
  \item output: $out := \textit{product details from the database that best match} \, \textit{inputItemData}$
