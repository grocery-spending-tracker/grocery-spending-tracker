...
\item output: \( \neg location = null \Rightarrow \textit{out} \coloneqq location \), where \textit{location} is the user location stored in the database (Section \ref{mDBDriver})
\item exception: \( location = null \Rightarrow \textit{exc} \coloneqq noLocationSavedException \), where \textit{location} is the user location stored in the database (Section \ref{mDBDriver})
\end{itemize}
