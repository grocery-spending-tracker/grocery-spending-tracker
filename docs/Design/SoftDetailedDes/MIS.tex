...
\item output: $out := getDateTime(receiptData)=GroceryTrip.dateTime, \text{ }getLocation(receiptData)=GroceryTrip.location,$
              $getItems(receiptData)=GroceryTrip.items, \text{ }getSubtotal(receiptData)=GroceryTrip.subtotal,$
              $getTotal(receiptData)=GroceryTrip.total$
\end{itemize}
...
\item output: $\text{Let } A=\{x : 0 \leq x \leq 9\}, B=\{x : 0 \leq x \leq 2\}, C=\{x : 0 \leq x \leq 5\}$ \\
              ...
              $out := containsDateTime(receiptData) \Rightarrow \text{return } data | \neg containsDateTime(receiptData) \Rightarrow \text{return } null$
\end{itemize}
...
\begin{itemize}
  \item output: $\text{Let } A=\{x : 0 \leq x \leq 9\}, B=\{a,b,\dots,y,z\}\cup\{A,B,\dots,Y,Z\}\cup\{\text{ }\}$ \\
                ...
                $out := containsLocation(receiptData) \Rightarrow \text{return } data | \neg containsLocation(receiptData) \Rightarrow \text{return } null$
\end{itemize}
...
\begin{itemize}
  \item output: $\text{Let } A=\{x : 0 \leq x \leq 9\}, B=\{a,b,\dots,y,z\}\cup\{A,B,\dots,Y,Z\}\cup\{\text{ }\}$ \\
                ...
                $out := itemList \text{ s.t. } \forall text(getItems(text) \land text \in receiptData) : itemList.append(text)$
\end{itemize}
...
\begin{itemize}
  \item output: $\text{Let } A=\{x : 0 \leq x \leq 9\}$ \\
                ...
                $out := containsSubtotal(receiptData) \Rightarrow \text{return } data | \neg containsSubtotal(receiptData) \Rightarrow \text{return } null$
\end{itemize}
...
\begin{itemize}
  \item output: $\text{Let } A=\{x : 0 \leq x \leq 9\}$ \\
                ...
                $out := containsTotal(receiptData) \Rightarrow \text{return } data | \neg containsTotal(receiptData) \Rightarrow \text{return } null$
\end{itemize}
