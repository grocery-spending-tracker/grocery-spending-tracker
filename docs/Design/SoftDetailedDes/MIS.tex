...
\section{MIS of User Analytics Module} \label{mLocation} 
...
Database Driver Module (Section \ref{mDBDriver})
Recommendation Engine (Section \ref{mRec})
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
getSpendingByCategory & $\mathbb{N}^2$ & List$<$(String, List$<$Item$>$)$>$  & - \\
getSpendingByTime & $\mathbb{N}^2$ & List$<$(String, $\mathbb{R}$+)$>$ & - \\
