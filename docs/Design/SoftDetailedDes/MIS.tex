...
% might also need to include Map depending on what Allan uses

\noindent
The specification of \progname \ uses some derived data types: lists, strings, and
tuples. Lists are data types that store an array of a set data type, formatted as $List<Object>$. Strings
