...
\begin{enumerate}
  ...
  it was not feasible to keep proceeding as we were. As a result, we ended up looking to using an existing
  ...
  Overall, most of our design decisions that we selected involved identifying constraints in our project
