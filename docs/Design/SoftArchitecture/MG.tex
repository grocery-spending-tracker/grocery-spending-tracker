...
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The structure of the data inputted to the server.
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The structure of the data returned from the server.
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The styling and formatting of UI components and user input.
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The table structure of the databases.
\end{description}
