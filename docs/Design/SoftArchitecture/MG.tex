...
\item [\refstepcounter{mnum} \mthemnum \label{mReview}:] Receipt Extraction & Review
...
\item [\refstepcounter{mnum} \mthemnum \label{mItem}:] Item List Processing Engine
