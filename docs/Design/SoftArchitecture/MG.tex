...
Testing of modules also takes place during the development window set by the team. In general,
testing will involve basic manual testing of the application features to simply build confidence for the
Revision 0 Demo. For modules whose development end date is prior to January 31, testing will take place
one week after this end date. For the other modules, testing will largely take place concurrently with development
