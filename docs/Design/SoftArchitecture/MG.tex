...
\begin{enumerate}
  ...
  of time, it generally isn't feasible to implement everything we would have liked to implement.
  ...
  \begin{itemize}
    ...
    \item Implementing our own OCR system specifically designed for receipt data
  ...
  \end{itemize}
  Given unlimited time, we believe these features would have greatly improved the quality
  of our application and would have been nice features to have.\\
  ...
  project. With the additional funds, we would be able to create an application that supports more people
  which would better accomplish our goal of helping more users save money.
