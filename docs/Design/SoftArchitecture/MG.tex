...
\subsubsection{Classification Engine Module (\mref{mRVision})}
...
\subsubsection{Recommendation Engine Module (\mref{mRVision})}

\begin{description}
\item[Secrets:] Language models and query/filtering algorithms required to generate best matct output.
