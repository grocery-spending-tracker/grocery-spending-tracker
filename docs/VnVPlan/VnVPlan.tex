...
\begin{enumerate}
  ...
  How test will be performed: A meeting will be held with testers where they are presented with the
  ...
  {https://github.com/r-yeh/grocery-spending-tracker/blob/master/docs/SRS/SRS.pdf}{SRS}.

  \item{NFRT-UH2\\}

  Type: Dynamic, Manual
					
  Initial State: Application is opened on a device and logged in to a user's account.
  ...
  Output: The font size should be changed throughout the application without negatively impacting functionality.
  ...
  Output: The colour scheme should be changed throughout the application without negatively impacting functionality.
  ...
  application. The questions asked will be as written in Section 6.2 of this document.
\end{enumerate}
