...
Input/Condition: The user selects their preferred units of measurement from the app settings.
					
Output/Result: The app interface and displayed measurements change to the selected units of measurement as per the user's choice.
...
Input: The user searches attempts to add a purchase item not present in the database.
					
Output: The app successfully adds the new purchase item to the user's purchase history.
					
How test will be performed: The tester will attempt to add a product not present in app product database to the purchase history and verify that the item is added without any issues.
