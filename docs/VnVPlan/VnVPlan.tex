...
This section outlines the testing plan for the functional requirements deteailed in the \href{https://github.com/r-yeh/grocery-spending-tracker/blob/master/docs/SRS/SRS.pdf}{Software Requirements Specification}.
...
\paragraph{Log-in and Authentication}

These tests pertain to all the functional requirements related to authentication and the user logging in to the system.
...
Output: Error message detailing an invalid email.
...
Output: Error message detailing an invalid phone number.
...
Output: Error message detailing an invalid password.
...
Output: User is provided an error message detailing invalid email.
...
Output: User is provided an error message detailing invalid password. Prompt to reset password is highlighted.
