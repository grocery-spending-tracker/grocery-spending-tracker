...
\begin{enumerate}
  ...
  without instruction from the team. After the time limit, the user will be asked to navigate to and explain
  each of the application's major functions based on functional requirements in the
  \href{https://github.com/r-yeh/grocery-spending-tracker/blob/master/docs/SRS/SRS.pdf}{SRS}.
  ...
  application. The questions asked will be as written in Section 6.3 of this document.
\end{enumerate}
...
\begin{enumerate}
  ...
  How test will be performed: The application will be navigated through while using \textit{Flutter Performance Profiling}
  in order to verify frontend rendering and performance is within expectation.

  \item{NFRT-PR2\\}

  Type: Automatic, Dynamic

  How test will be performed: A test suite will be executed with \textit{Postman} and server response times will be recorded
  to verify backend performance.

  \item{NFRT-PR3\\}

  Type: Automatic, Dynamic

  How test will be performed: Error test cases will be sent to the backend using \textit{Postman} to verify that the
  backend can withstand incorrect types and inputs.
