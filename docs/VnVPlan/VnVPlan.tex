...
\begin{enumerate}
  ...
  For the verification and validation of this project, a number of skills will be required
  ...
  \begin{enumerate}
    \item Knowledge of conducting and different forms of dynamic testing
    \item Knowledge of conducting and different forms of static testing
  ...
  For skills \textit{(a)} and \textit{(b)}, an approach that could be taken is to review notes from
  \textit{SFWRENG 3S03} where topics such as dynamic and static testing were covered as well as different methods
  and approaches for each. Additionally, articles and resources can also be found on the internet covering
  the basics of these testing approaches. \par

  Skills \textit{(c)} and \textit{(d)} are more specific technologies, so one approach to learning these
  skills could be to read documentation. For both technologies, documentation is present to learn how the
  ...
  could provide more insight on how these applications can be used for testing. Lastly, third-party articles
  can also be used for additional learning. \par

  Skill \textit{(e)} is more of a social skill rather than a technical skill. As such, the approach for learning
  and improving this skill would be different compared to the other approaches above. One way to improve
  communication skills for testing could be with group collaboration and interaction. For instance, before using
  a survey, getting it reviewed by the team could result in flaws or issues being identified which can be
  noted for the future. Furthermore, \textit{SFWRENG 3S03} had some lectures on surveys and similar approaches
  for testing that could also be reviewed to better learn this skill.
  ...
  given that they will be the main technologies that unit tests will be conducted with. By ensuring proper learning of
  this software, I should be able to better guide the rest of the team during unit testing development resulting
  ...
  knowledge as well as practical user knowledge. In terms of communication skills, I will be employing group feedback
