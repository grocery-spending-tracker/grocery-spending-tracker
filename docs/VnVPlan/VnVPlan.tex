...
\begin{enumerate}
  ...
  I am going to be responsible for the FR system tests and the unit tests for the system. Therefore, I believe it is important for me to have a deep understanding of dynamic testing, static testing, and use of \textit{Postman} for API testing. Through having a deep understanding of these concepts and skills, I can contribute to the project's correctness and testing depth.
  In order to develop my Dynamic testing and Static testing skills, I plan to reference my \textit{SFWRENG 3S03} notes and resources, as well as putting into practice skills from online articles and forums. With regards to improving my abilities with \textit{Postman}, I plan to reference \textit{YouTube}, blogs, and \textit{Postman's} own documentation.
