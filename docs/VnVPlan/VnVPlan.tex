...
How test will be performed: Attempts will take place to access database without accepting terms. The tester will confirm denial of access. Then, attempt access after accepting terms and services. The tester will confirm successful database access.
...
How test will be performed: The tester will perform a variety of user actions and try to trigger system events. The tester will verify if these actions and events are accurately logged to system log. The tester will confirm that only authorized administrators can access these logs.
